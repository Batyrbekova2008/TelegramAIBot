...
FUNCTIONS_MAP = {
    "get_current_time": get_current_time, "get_weather": get_weather,
    "get_os_info": get_os_info, "get_system_resources": get_system_resources, "calculate_math": calculate_math
}